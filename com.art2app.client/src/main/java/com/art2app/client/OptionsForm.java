...
import com.art2app.client.OptionsForm.MainBox.GroupBox.UiThemeField;
import com.art2app.shared.UiThemeCodeType;
...
public class OptionsForm extends AbstractForm {
  ...
  protected void execInitForm() {
    String theme = StringUtility.nvl(getDesktop().getTheme(),"dark");
